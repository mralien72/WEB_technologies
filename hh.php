...
$experiences = [
        ...
        [
            'professions' => 'Web Developer / something.com',
            'date_start' => 'Mar 2012',
            'date_end' => 'Dec 2014',
        ...
        [
            'professions' => 'Graphic Designer / designsomething.com',
            'date_start' => 'Jun 2010',
            'date_end' => 'Mar 2012',
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach($experiences as $experience): ?>
          <h5 class="w3-opacity"><b><?=$experience['professions']?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$experience['date_start']?> - <?=$experience['date_end']?></h6>
